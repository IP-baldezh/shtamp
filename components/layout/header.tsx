...
const navigation = {
  services: {
    ...
    items: [
      {
        name: "Изготовление штампов",
        href: "/services/stamps",
        description: "Штампы холодной штамповки любой сложности",
      },
      {
        name: "Проектирование",
        href: "/services/design",
        description: "3D-моделирование и конструкторская документация",
      },
      {
        name: "Ремонт и модернизация",
        href: "/services/repair",
        description: "Восстановление и улучшение оснастки",
      },
      {
        name: "Пресс-формы",
        href: "/services/molds",
        description: "Формы для литья пластмасс и металлов",
      },
    ],
  },
  company: {
